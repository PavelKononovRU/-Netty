...
В gateway-service была добавлена динамическая маршрутизация, Теперь он сам будет получать все микросервисы,
зарегистрированные в Eureka Server. Для более точных маршрутов перенаправления, возможно вручную добавить
в config-файл gateway-service. Для ручного добавления:
